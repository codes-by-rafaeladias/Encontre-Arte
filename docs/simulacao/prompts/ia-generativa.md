# Prompt para Geração de Sugestões Inteligentes

Este documento apresenta o prompt utilizado para geração de conteúto textual na funcionalidade 'Sugestões Inteligentes'.
